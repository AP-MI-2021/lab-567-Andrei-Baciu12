...
def get_data():
    return [
        creeaza_cheltuiala(id, 1, 100, '27.09.2021', 'alte cheltuieli'),
        creeaza_cheltuiala(id, 5, 250, '12.10.2021', 'intretinere'),
        creeaza_cheltuiala(id, 6, 300, '20.09.2021', 'canal'),
        creeaza_cheltuiala(id, 7, 200, '12.01.2021', 'alte cheltuieli')
    ]


def test_create():
    cheltuieli = get_data()
    noua_cheltuiala = creeaza_cheltuiala(id, 2, 50, '31.10.2021', 'intretinere')
    lista_noua_de_cheltuieli = create(id, cheltuieli, 2, 50, '31.10.2021', 'intretinere')
...
def test_update():
    cheltuieli = get_data
    new_cheltuiala = creeaza_cheltuiala(id, 5, 210, '10.10.2020', 'alte cheltuieli')
